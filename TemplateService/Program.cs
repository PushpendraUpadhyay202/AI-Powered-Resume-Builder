...
builder.Services.AddScoped<ITemplateService, TemplateService.Services.TemplateService>();
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "TemplateService API", Version = "v1" });
